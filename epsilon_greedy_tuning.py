...
if __name__ == "__main__":
    ...
    if not prompt:
        ...
        # Test all combinations of epsilon and k
        for epsilon in epsilon_values:
            for k in k_values:
                print(f"\nTesting Epsilon Greedy Search with ε={epsilon}, k={k}...")
                generated_texts = generate_text(
                    prompt, max_length=max_length, epsilon=epsilon, k=k, num_return_sequences=num_return_sequences
                )
                ...
                print(f"Scores for ε={epsilon}, k={k}: {scores}")
        ...
        # Save all results
        save_path = "hyperparameter_tuning_results.json"
