...
def generate_text_with_strategy(prompt, max_length=50, num_return_sequences=1, strategy="epsilon_greedy", epsilon=0.8, k=5, top_p=0.9, num_beams=3):
    """
    ...
    if strategy == "epsilon_greedy":
        ...
        return outputs  # Directly return generated text from epsilon_greedy_search

    elif strategy == "greedy":
        # Enforce num_return_sequences = 1 for greedy strategy
        if num_return_sequences > 1:
            print("Warning: Greedy strategy does not support num_return_sequences > 1. Using num_return_sequences = 1.")
